-- GENERATED by Palvolve-Web/pipeline/build-condition-catalogs.mjs from the pinned UE4SS object dump.
-- Run that generator after updating the dump for a game patch. EPalWazaID name -> numeric value.
return {
    ["None"] = 0,
    ["Human_Punch"] = 1,
    ["WorkAttack"] = 2,
