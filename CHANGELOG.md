...
- **The Fusion Altar turns two Pals into one for good.** It is a stone gate over two pedestals, and the two Pals wait there facing each other. The fusion plays as a filmed scene: the camera circles the altar while both Pals rise, circle inside the gate and burst into the new Pal. Build it from the Pal section of the build menu, put two of your Pals in, pick "Fusion Altar" in the wheel and choose up to four passives and the gender. The second Pal is used up, and each fusion costs a Fusion Core.
