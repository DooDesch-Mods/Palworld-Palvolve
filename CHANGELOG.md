...
- **The Fusion Altar turns two Pals into one for good.** It is a stone stage with two pedestals, and the two Pals wait there facing each other. Build it from the Pal section of the build menu, put two of your Pals in, pick "Fusion Altar" in the wheel and choose up to four passives and the gender. The second Pal is used up, and each fusion costs a Fusion Core.
